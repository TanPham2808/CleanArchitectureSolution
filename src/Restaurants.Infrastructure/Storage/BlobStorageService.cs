...
{
    public class BlobStorageService(IOptions<BlobStorageSettings> blobStorageSettingsOptions) 
        : IBlobStorageService
    {
        // Lấy cấu hình từ IOptions<BlobStorageSettings>
        private readonly BlobStorageSettings _blobStorageSettings = blobStorageSettingsOptions.Value;

        // Tạo URL có SAS token để truy cập blob
